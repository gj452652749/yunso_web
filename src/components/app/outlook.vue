...
<script>
    ...
    // import MetisMenu from '../../../static/assets/js/plugins/metisMenu/jquery.metisMenu.js'
    // import slimScroll from '../../../static/assets/js/plugins/slimscroll/jquery.slimscroll.min.js'
    // import Pace from '../../../static/assets/js/plugins/pace/pace.min.js'
    // var slim=require('../../../static/assets/js/plugins/slimscroll/jquery.slimscroll.min.js');
